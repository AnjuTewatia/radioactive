...
const SingleProduct = () => {
  ...
  return (
    ...
    <Flex>
          ...
          <Box mt={"50px"}>
            <Box width={"130px"}><Image id="hov"  mt={"10px"}  onClick={()=>setImg(product.image1)} src={product.image1} /></Box>
            <Box width={"130px"}><Image id="hov" mt={"10px"} onClick={()=>setImg(product.image2)}  src={product.image2} /></Box>
            <Box width={"130px"}><Image id="hov" mt={"10px"} onClick={()=>setImg(product.image3)}  src={product.image3} /></Box>
            {/* <Image onClick={()=>setImg(product.image4)} boxSize={"100px"} src={product.image4} /> */}
          </Box>
          <Box style={{boxShadow:" rgba(100, 100, 111, 0.2) 0px 7px 29px 0px",borderRadius:"10px"}} mt={"50px"} marginLeft={"50px"} >
          <Image id="hov"  width={755} src={curimg} alt=""
        fit={'cover'}
        align={'center'}
        ...
        <Box ml="120px" mr="90px" paddingTop={"70px"}   style={{boxShadow:"rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
