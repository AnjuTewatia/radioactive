...
const Bags = () => {
  ...
  return (
    <>
     ...
     <Image width={"100%"} height={"200px"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHfdBatOGmWW_LbCZb2GqxoWUiBeM7TC3z7W81vslPWSFZSdio-6yoikXUvtU5Pxo9FyY&usqp=CAU"/>
