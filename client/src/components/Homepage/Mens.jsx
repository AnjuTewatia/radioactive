...
const Mens = () => {
  ...
  useEffect(() => {
    axios
      .get("https://rich-puce-abalone-gear.cyclic.app/product?category=Mens")
      .then((response) => {
  ...
  return (
    <>
      ...
      <Image
        width={"100%"}
        height={"300px"}
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTS5jxEwZTzUUVId3XvLS_GTyjr0_basPFUQ&usqp=CAU"
      />
